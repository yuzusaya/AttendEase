...
namespace AttendEase.UnitTest
{
    public class TimeUtilityTest
    {
        ...
        [InlineData(8,41,8,55)]
        [InlineData(8,42,8,55)]
        ...
        [InlineData(8,49,9,0)]
        [InlineData(8,50,9,0)]
        [InlineData(8,51,9,05)]
        [InlineData(8,52,9,05)]
        ...
        [InlineData(17, 33, 17, 20)]
        [InlineData(17, 34, 17, 20)]
        [InlineData(17, 35, 17, 25)]
        [InlineData(17, 36, 17, 25)]
        [InlineData(17, 37, 17, 25)]
        [InlineData(17, 38, 17, 25)]
        [InlineData(17, 39, 17, 25)]
        [InlineData(17, 40, 17, 30)]
        [InlineData(17, 41, 17, 30)]
        [InlineData(17, 42, 17, 30)]
        [InlineData(17, 43, 17, 30)]
        [InlineData(17, 44, 17, 30)]
